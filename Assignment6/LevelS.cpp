...
void LevelS::initialise(int lives)
{
    ...
    m_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVELS_DATA, map_texture_id, 1.0f, 7, 2);
    ...
    m_state.player->set_position(glm::vec3(5.0f, -3.7f, 0.0f));
...
void LevelS::render(ShaderProgram* program)
{
    ...
    Utility::draw_text(program, font_texture, "WELCOME TO:", 0.9f, -0.45f, glm::vec3(2.5f, -2.0f, 0.0f));
    Utility::draw_text(program, font_texture, "MINI GOLF ADVENTURE", 0.9f, -0.45f, glm::vec3(1.0f, -3.0f, 0.0f));
    Utility::draw_text(program, font_texture, "PRESS ENTER TO PLAY", 0.9f, -0.45f, glm::vec3(1.0f, -4.0f, 0.0f));
}