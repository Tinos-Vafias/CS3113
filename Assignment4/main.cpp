...
const char  SPRITESHEET_FILEPATH[] = "C:/Users/zouan/Downloads/stick_figure.png",
PLATFORM_FILEPATH[] = "C:/Users/zouan/CS3113/Assignment3/ice.png",
ENEMY_FILEPATH[] = "C:/Users/zouan/CS3113/Assignment3/fire.png";


const char  BGM_FILEPATH[] = "C:/Users/zouan/CS3113/Beauty Flow.mp3",
BOUNCING_SFX_FILEPATH[] = "C:/Users/zouan/CS3113/mixkit-casino-bling-achievement-2067.wav";
...
void initialise()
{
    ...
    // upper platforms
    int x = 0;
    for (int i = 10; i < PLATFORM_COUNT; i++)
    {
        g_game_state.platforms[i].m_texture_id = platform_texture_id;
        g_game_state.platforms[i].set_position(glm::vec3(x - 1.5f, -1.0f, 0.0f));
        g_game_state.platforms[i].set_width(0.4f);
        g_game_state.platforms[i].update(0.0f, NULL, NULL, 0, false);
        x++;
    }
    ...
    g_game_state.enemies[0].set_position(glm::vec3(1.5f, 2.0f, 0.0f));
    ...
    g_game_state.enemies[1].set_position(glm::vec3(3.5f, 0.0f, 0.0f));
    ...
    g_game_state.enemies[2].set_position(glm::vec3(3.5f, -2.25f, 0.0f));
...
void update()
{
    ...
    while (delta_time >= FIXED_TIMESTEP) {
        ...
        g_game_state.player->update(FIXED_TIMESTEP, g_game_state.player, g_game_state.enemies, ENEMY_COUNT, true);

        for (int i = 0; i < ENEMY_COUNT; i++) g_game_state.enemies[i].update(FIXED_TIMESTEP, g_game_state.player, g_game_state.platforms, PLATFORM_COUNT, false);
...
void render()
{
    ...
    // if all enemies are deactivated, render win message
    int death_count = 0;
    for (int i = 0; i < ENEMY_COUNT; i++) {
        if (g_game_state.enemies[i].defeated == true) {
            death_count++;
        }
    }
    ...
    if (death_count == ENEMY_COUNT) {
        // render win message
        draw_text(&g_shader_program, load_texture("C:/Users/zouan/Downloads/font1.png"), "YOU WIN!", 1.0f, -0.25f, glm::vec3(-2.5f, 0.5f, 0.0f));
    }

    // if player is deactivated, render loss message
    if (g_game_state.player->defeated == true) {
        // render loss message
        draw_text(&g_shader_program, load_texture("C:/Users/zouan/Downloads/font1.png"), "YOU LOSE!", 1.0f, -0.25f, glm::vec3(-2.5f, 0.5f, 0.0f));
    }
